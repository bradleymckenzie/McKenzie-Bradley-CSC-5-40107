...
int main(int argc, char** argv) {
    ...
    unsigned short year;
    //Input Values
    cout<<"The program converts years to Roman numerals"<<endl;
...
//Inputs: Years -> 1000 to 3000
//Outputs: romanYr -> Out to the
//******************************************************************************
string cnvrtRN(int year){
    //Declare Variables
    char n100,n1000,n10,n1;//The number of powers of 10
    string roman="";
